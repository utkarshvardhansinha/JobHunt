  ...
  return (
    <div className='p-5 rounded-md shadow-xl bg-white border-gray-100'>
      ...
      <div>
        ...
        <p className='text-sm text-gray-600 '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat inventore, blanditiis nulla ea dolores ab voluptas illo esse quibusdam doloremque?</p>
      </div>
